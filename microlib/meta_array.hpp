...
namespace ulib {
	namespace meta {
		namespace deprecated {
			...
			template< typename StaticArray, size_t index, typename StaticArray::type value, typename NewArray = array<typename StaticArray::type> >
			struct set;

			template< size_t index, typename Type, Type src_element0, Type... src_tail, Type... dest_list, typename array< Type, src_element0, src_tail... >::type value >
			...
			template< typename Type, Type src_element0, Type... src_tail, Type... dest_list, typename array< Type, src_element0, src_tail... >::type value >
