...
namespace ulib
{
    ...
    namespace detail
    {
        ...
        struct pool_element_type
        {
            ...
            using storage_type =
                typename std::aligned_storage<max(sizeof(Type), sizeof(pool_element_type *)),
                                              max(std::alignment_of<Type>::value, std::alignment_of<pool_element_type *>::value)>::type;
    ...
    struct pool_ptr
    {
        ...
        pool_ptr(pointer_type the_element) : the_element_(the_element)
        {
        }

        pool_ptr(pool_ptr &&other) : the_element_(nullptr)
        {
